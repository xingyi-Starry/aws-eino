...
require (
	...
	github.com/cloudwego/eino-ext/components/embedding/dashscope v0.0.0-20260214075714-8f11ae8e65a2
...
require (
	...
	github.com/cloudwego/eino-ext/callbacks/cozeloop v0.1.8 // indirect
